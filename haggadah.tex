...
keepaspectratio]{stock.jpg}}%
\vfill
}}}
\title{Haggadah}
\author{Seder for the perplexed and perplexing family}
\date{Pesach, 5778}
\begin{document}
...
%\ThisTileSquareWallPaper{6}{stock.jpg}
\thispagestyle{empty}
...
ya{\ch}atz}. At this point in the evening the children search for the matzah,
...
\begin{HgTranslit}
  Yishtaba{\ch} shim{\ch}a l'ad malkeinu \\
  ha'el hamele{\ch} hagadol v'hakadosh bashamayim u'v'aretz \\
  ki l'{\ch}a na'eh, Adonai eloheinu v'elohei avoteinu \\

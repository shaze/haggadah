...
\includegraphics[width=155mm]{figs/zara.jpg}\\
\end{tabular}
\newpage
\begin{tabular}{c}
\includegraphics[width=9cm]{figs/charlie}
\end{tabular}
...
\item Major  source material for this haggadah was the {\LaTeX}
  source of the The Columbia Commune Churchill Free Haggadah, which had been

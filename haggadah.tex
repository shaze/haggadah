...
% Set false if Pesach is not on Shabbat to reduce the number of alternates
\newif\ifshabbat \shabbattrue
...
\end{HgTranslit}
\begin{HgHebrew}
% THis is included as a bug fix -- without it the TOC is wrong
\end{HgHebrew}
...
\chapter{Motzi and Matzah: Blessing the bread and matzah}

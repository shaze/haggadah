...
\setmainfont[ Path =
/usr/local/texlive/2017//texmf-dist/fonts/opentype/kosch/crimson/ ,
 UprightFont = Crimson-Roman.otf,
 BoldFont = Crimson-Bold,
 ItalicFont = Crimson-Italic ] {Crimson}
...
\begin{document}
\frontmatter
\definecolor{Mycolor2}{HTML}{9EB3FF}
\definecolor{oats}{HTML}{e8d2b1}
\definecolor{jonipink}{HTML}{ffa6fe}
\definecolor{jonigrey}{HTML}{82848a}
\newpagecolor{jonigrey}\afterpage{\restorepagecolor}
\pagenumbering{roman}
...
% \begin{center}
% \begin{tabular}{r}
% \includegraphics[width=35mm,trim=25mm 0mm 0mm 0mm]{figs/0A010-vayehi}\\
% \includegraphics[width=125mm,trim=0mm 0mm 2mm 0mm,clip]{figs/0A014-vayechulu}\\
% \end{tabular}
% \end{center}
%
%\newpage
...
\hspace*{3cm}\begin{tabular}{r}
\includegraphics[width=8.8cm,trim=0 16mm 0 0]{figs/0A020-kiddush1}\\
\includegraphics[width=8.8cm]{figs/0A024-kiddush2}\\
\end{tabular}
...
\HgInst{Wash your hands, without reciting a
  blessing. Wash for at least 20 seconds, making sure to wash the back of
  your hands, your thumbs, and the tips of your fingers. Finally, your
  wrists. Dry with your fingers facing up. (The House of Shammai says
  you should move your hands counter-clockwise while washing. The House of Hillel
  says as long as you use soap and water it's kosher.) }
...
thy life.''``The days of your life'' would have meant the
...
our voice and saw our suffering, our labour and our oppression, and
...
\begin{HgEnglish}
  ...
  Because the Egyptians made our ancestors' lives bitter with hard labour, and
...
\begin{tabular}{l}
\includegraphics[width=153mm,trim=0 0 0 25mm,clip]{figs/bbb1.jpeg}\\[12pt]
\includegraphics[width=153mm,trim=0 35mm 0 82mm,clip]{figs/bbb2.jpeg}\\
\end{tabular}

\newpage
\begin{tabular}{l l}
\multicolumn{2}{l}{\includegraphics[width=155mm]{figs/sl2.jpeg}}\\
\includegraphics[width=9cm,trim=0mm 40mm 0mm 0mm,clip]{figs/sl1}
  &
    \includegraphics[width=6cm,trim=0mm 40mm 0mm 40mm,clip]{figs/sl3}    \\
  \multicolumn{2}{l}{\includegraphics[width=155mm,trim=0mm 0mm 0mm 20mm,clip]{figs/wedding.jpeg}}\\
\end{tabular}

\newpage
\begin{tabular}{l l}
\multicolumn{2}{l}{\includegraphics[width=12cm,trim=1mm 40mm 0mm 160mm,clip]{figs/amy.jpeg}}\\
\includegraphics[width=8cm,trim=1mm 40mm 1mm 0mm,clip]{figs/joni}
  &
\includegraphics[width=8cm,trim=0mm 40mm 30mm 80mm,clip]{figs/sj}    \\  
\multicolumn{2}{l}{\includegraphics[width=164mm,trim=0mm 40mm 0mm 80mm,clip]{figs/jhb}}
\end{tabular}
\newpage
\newpagecolor{jonigrey}\afterpage{\restorepagecolor}
\phantom{.}
...
\begin{center}
  \includegraphics[width=15cm]{figs/viv.jpeg}
  \\[2mm]
...
\end{document}
h v« ¥ « k ¡t  ̈h §h v T ̈ t© Q U r C ̈h v« ¥ « k ¡t  ̈h §h v T ̈ t© Q U r C ̈
%%% Local Variables: 
%%% mode: latex
%%% TeX-master: t
%%% End: 

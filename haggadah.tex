...
%\fontspec [Path = /Users/scott/Library/texmf/fonts/truetype/culmus/ ,
%UprightFont = *Regular,  BoldFont = *Demi-Bold, Extension= .ttf]{Shofar.ttf}
%\fontspec [Path = /Users/scott/Library/texmf/fonts/truetype/culmus/ ,UprightFont = *-Regular,  BoldFont= *-Bold]{HadasimCLM}
...
\newfontfamily\hebrewfont[Path = /Users/scott/Library/texmf/fonts/truetype/culmus/ ,
UprightFont = *Regular,  BoldFont = *Demi-Bold, Extension= .ttf,Script=Hebrew]{Shofar}
...
%\setmainfont[ Path =\string~/Library/texmf/fonts/opentype/impallari/quattrocento/ ]{Quattrocento}


%\setmainfont[ Path = ~/Library/texmf/fonts/opentype/catharsis/cormorantgaramond/ , UprightFont = CormorantGaramond-SemiBold.otf, BoldFont = CormorantGaramond-Bold, ItalicFont = CormorantGaramond-SemiBoldItalic ]{Cormorant Garamond}



%\setmainfont[ Path =~/Library/texmf/fonts/opentype/impallari/raleway/ ]{Raleway}
...
\title{\vspace*{-4cm}\sffamily Haggadah}

\author{\vspace*{-1cm}\sffamily Seder for the perplexed \& perplexing family}
\date{}
...
\textbf{\Large \sffamily The Passover seder}
...
\chapter{Lighting the candles}

The candles may be lit before sunset or  at the start of the
seder, according to custom:

\begin{verse}
  As these candles give light to all who behold them,\\
  so may we, by our lives, give light to all who behold us.\\
  
  As their brightness reminds us of the generations of Israel who have
  kindled light,\\
  so may we, in our own day, be among those who kindle light.\\
  \hfill \emph{-- Mishkan T'filah}
\end{verse}

\bigskip

\noindent
If Pesach is on Shabbat:

\medskip

\begin{cjhebrew}\LARGE
  b*ArUK:  't*Ah\textrm{,}  y:yA  'E:lohenU\textrm{,} mElEK:  hA`OlAm\textrm{,}\\
  'a:+sEr qid*:+sanU  b*:mi.s:OtAyw\\
  w:.siw*anU l:had:liyq ner +sEl +sab*at w:+sEl yOm tob\textrm{.}
\end{cjhebrew}
...
\begin{cjhebrew}\LARGE
  b*ArUK:  't*Ah\textrm{,}  y:yA  'E:lohenU\textrm{,} mElEK:  hA`OlAm\textrm{,}\\
  'a:+sEr qid*:+sanU  b*:mi.s:OtAyw\\
  w:.siw*anU l:had:liyq ner  +sEl yOm tob\textrm{.}
\end{cjhebrew}
...
\vfill
\noindent
``All who are hungry\ldots '' may be literal, reminding us of our duty
to seek justice for others. But, it may also be be thought of
figuratively, as an invitation to everyone around the table in need of
...
\noindent
\textbf{\large The  four questions.}
...
\begin{HgEnglish}
The length of time that the Israelites lived in Egypt was four hundred
and thirty years; at the end of the four hundred and thirtieth year,
to the very day, all the ranks of Adonai departed from the land of
Egypt. That was for Adonai a night of vigil to bring them out of the
land of Egypt; that same night is Adonai’s, one of vigil for all the children of Israel throughout the ages.
\end{HgEnglish}
...
\begin{HgEnglish}
Rabbi Yonatan says: What is the meaning of that which is written in
the passage describing the splitting of the Red Sea: “And the one came
not near the other all the night”?

At that time the angels recited a
song of joy. The Holy One said: My handiwork -- the Egyptians -- are drowning in
the sea, and you are reciting a song before Me? Apparently, God is not
gladdened by the downfall of the wicked.

\hfill\emph{Talmud, Sanhedrin, 39b}
\end{HgEnglish}
...
\begin{HgEnglish}
  ...
  ad he only split the sea for us, and not taken us through on dry land, dayenu!\\
...
of what God did for me when I left Egypt.'
  ...
  We remember that we were slaves, we who were strangers, and so we
  remember:
  \begin{itemize}
  \item You shall not oppress a stranger, for you know the feelings of
    a stranger having yourselves been strangers in the lange of
    Egypt. When strangers reside with you in your land, you shall not
    wrong them \ldots you shall love them as yourselves.
  \item You shall rejoice before God with your son and daughther and
  the stranger, and the orphan and widow in your midst.
  \end{itemize}
\end{HgEnglish}
...
entertainment featuring drunken revelry.
\end{HgEnglish}
...
\chapter{Counting the omer: from the second night}

Counting of the Omer is done each night between Pesach and
Shavuot.  These two days were pilgrimage festivals, with the first
being associated with the barley harvest and the latter with the wheat
harvest -- an \emph{omer} is a measure of grain, usually barley. This
is the commandment:

\begin{verse}
And from the day on which you bring the sheaf of elevation
offering—\\
the day after the sabbath—you shall count off seven
weeks.\\
They must be complete: you must count until the day after the
seventh week—fifty days; \\
then you shall bring an offering of new grain
to Adonai.\\
\hfill-- \emph{Leviticus, 23:15-16}
\end{verse}

\noindent
Counting of the Omer may have been an important ritual for an
agricultural society, for which the success the crops
was very important. Later this period between Pesach and Shavuot was associated with
the start of the transition  from being slaves to free
people. We  mark each day to remember the process.  
Pesach to Shavuot.

\medskip

\HgInst{Say the blessing.}

\begin{cjhebrew}\LARGE
  b*ArUK:  't*Ah\textrm{,}  y:yA  'E:lohenU\textrm{,} mElEK:  hA`OlAm\textrm{,}\\
  'a:+sEr qid*:+sanU  b*:mi.s:OtAyw\\
  w:.siw*anU `la s:pirat ha`omEr\textrm{.}
\end{cjhebrew}

\begin{HgTranslit}
Baruch atah Adonai Eloheinu melech ha’olam asher kid’shanu b’mitzvotav
vitzivanu \\al sefirat ha’omer.
\end{HgTranslit}
...
\HgInst{And then, mark the counting -- only from the second night of Pesach:}

\begin{HgEnglish} \centering
  \textbf{Today is the first day of the Omer.}
\end{HgEnglish}

\medskip
\noindent
(For subsequent nights, use the pattern ``Today is the third day of
the Omer'' or ``Today is the 17th day of the Omer, making two weeks
and three days''.)

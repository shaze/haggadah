...
\author{\huge Seder for the perplexed and perplexing family}
...
\noindent\hspace*{-5cm}
\includegraphics[width=23cm]{figs/matzo.jpg}
\thispagestyle{empty}
...
\vfill
\noindent
This  haggadah is produced in {\LaTeX} (xetex). The English text is
...
\begin{HgEnglish}
In most families, it is customary to hide the matzah during 
